...
- Upstream base: OpenAI Codex `rust-v0.146.0`, packaged as `0.146.0` on npm `next`. The `latest` dist-tag remains on `0.144.1`; `stable` stays on `0.143.0` for conservative installs.
