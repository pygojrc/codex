...
- Upstream base: OpenAI Codex `rust-v0.144.4`, packaged as `0.144.4` on npm `next`. The `latest` dist-tag remains on `0.144.1`; `stable` stays on `0.143.0` for conservative installs.
