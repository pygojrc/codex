# Codex Termux 0.140.0 - Device Validation Report

- Date: 2026-06-16
- Package under test: `@mmmbuto/codex-cli-termux@0.140.0`
- Platform: Android/Termux on a physical ARM64 device
- Validation mode: AI-guided device checks

## Scope

Post-install validation of the current Termux build on the device, with focus
on command surface, runtime smoke, and Termux-specific packaging checks.

## Environment Summary

- Installed CLI version: `codex-cli 0.140.0`
- Installed exec wrapper version: `codex-exec 0.140.0`
...
PASS - `@mmmbuto/codex-cli-termux@0.140.0` is validated on the device.
